...
//        final String filenameTrain  = new ClassPathResource("/data/classification/linear_data_train.csv").getFile().getPath();
//        final String filenameTest  = new ClassPathResource("/data/classification/linear_data_eval.csv").getFile().getPath();

        final String filenameTrain  = "data/classification/linear_data_train.csv";
        final String filenameTest  = "data/classification/linear_data_eval.csv";
